          ...
          categoryData.map((item,index)=>{
            ...
            return display === '1' ? 
              <Link key={name+id} 
                  ...
                  className=" relative cursor-pointer text-2xl text-white md:text-xl bg-no-repeat bg-cover bg-center flex justify-center items-center tracking-wider hover:tracking-[.25em] transition-all    "
